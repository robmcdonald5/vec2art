	...
	theme: {
		extend: {
			...
			backgroundImage: {
				...
				'hero-gradient':
					'linear-gradient(135deg, #0f172a 0%, #1e293b 20%, #312e81 40%, #1e40af 60%, #1e293b 80%, #0f172a 100%)',

				// Features: Light Neutral Vertical (90deg)
				'features-gradient':
					'linear-gradient(90deg, #ffffff 0%, #f8fafc 20%, #f1f5f9 40%, #e2e8f0 60%, #f1f5f9 80%, #ffffff 100%)',

				// Algorithm: Medium Warm Diagonal Opposite (45deg)
				'algorithm-gradient':
					'linear-gradient(45deg, #fef3c7 0%, #fde68a 25%, #fed7aa 50%, #fecaca 75%, #fde68a 100%)',
				...
				'features-gradient-dark':
					'linear-gradient(90deg, #1e293b 0%, #334155 20%, #475569 40%, #64748b 60%, #475569 80%, #334155 100%)',
				'algorithm-gradient-dark':
					'linear-gradient(45deg, #374151 0%, #4b5563 25%, #6b7280 50%, #9ca3af 75%, #6b7280 100%)'
			},
			animation: {
