...
export interface InitOutput {
  ...
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder10for_sketch17h1b74d8cdd64590d8E: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder19for_dense_stippling17h92f5becb2318f67eE: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder15for_pointillism17hf62cdb50ddef5535E: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder17for_bold_artistic17h95e9364ae97d9aadE: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder15for_sparse_dots17h06ff9658e6b71f1eE: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder18for_fine_stippling17ha7e4c1efeecf5082E: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder13for_technical17h9e67bd19da9e15e9E: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder12for_line_art17h380a3f675403e75aE: (a: number) => void;
  readonly wasmvectorizer_set_backend: (a: number, b: number, c: number) => [number, number];
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder15backend_by_name17heeeab18c761e14abE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN89_$LT$vectorize_core..config_builder..ConfigBuilderError$u20$as$u20$core..fmt..Display$GT$3fmt17h2209084a04f954a2E: (a: number, b: number) => number;
  readonly wasmvectorizer_get_backend: (a: number) => [number, number];
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder5build17hfd44cd6a348c1cdbE: (a: number, b: number) => void;
  readonly wasmvectorizer_set_detail: (a: number, b: number) => [number, number];
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder6detail17h75b81787a6ec38b6E: (a: number, b: number, c: number) => void;
  ...
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder12stroke_width17h96f9456e65d7846eE: (a: number, b: number, c: number) => void;
  ...
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder11dot_density17hb24ca2a07300f836E: (a: number, b: number, c: number) => void;
  readonly wasmvectorizer_set_dot_size_range: (a: number, b: number, c: number) => [number, number];
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder14dot_size_range17h38529c96d6a40b38E: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder20background_tolerance17h6fc24e8b2a13618fE: (a: number, b: number, c: number) => void;
  readonly wasmvectorizer_set_hand_drawn_preset: (a: number, b: number, c: number) => [number, number];
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder17hand_drawn_preset17hdabe4920c3e4e301E: (a: number, b: number, c: number, d: number) => void;
  readonly wasmvectorizer_set_custom_tremor: (a: number, b: number) => [number, number];
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder13custom_tremor17hdb87c2ceed4deaacE: (a: number, b: number, c: number) => void;
  readonly wasmvectorizer_set_custom_variable_weights: (a: number, b: number) => [number, number];
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder23custom_variable_weights17h13c757695a6d923aE: (a: number, b: number, c: number) => void;
  ...
  readonly _ZN14vectorize_core24vectorize_trace_low_rgba17hf53dc529ba171b75E: (a: number, b: number, c: number) => void;
  readonly _ZN76_$LT$vectorize_core..error..VectorizeError$u20$as$u20$core..fmt..Display$GT$3fmt17h92f81a408a360decE: (a: number, b: number) => number;
  ...
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder21directional_threshold17h041707ceb3925e96E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder19conservative_detail17hc5ddfed6e86febcaE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder17aggressive_detail17h454c47bf33b36c90E: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly _ZN14vectorize_core10algorithms5edges12compute_fdog17hb6572c43555d2400E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h74e5ac38a9595b35E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms10background11rgba_to_lab17h90f31d098635c29dE: (a: number, b: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17h1e14d9c57280f573E: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17h1fc338c07e3e1106E: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17h29aaf6a8785bfc7fE: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17h43f2c84485f5c5dfE: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17h7e2798a9746008c1E: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17haccf5ee7412f1eddE: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17hbfcb0966a7ea34a7E: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17hc7810cc29df33d3dE: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17hd23b8be869de9a86E: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable14driftsort_main17hef5b21595ebce7c6E: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h8b4be33dbb18a0a6E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h9787e8672f71f880E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h28aa2699828a0b6dE: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h95fee882abf5d937E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h930694c3b9b4ed08E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h8f5fc9738f4b8d32E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h71f4d674c803a1f4E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h61fa0d4adae4323dE: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h986a3c5d4b898d5fE: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort6stable9quicksort9quicksort17h9eb08c38ba862229E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN4core5slice4sort8unstable7ipnsort17hc5e9e6016be6da22E: (a: number, b: number, c: number) => void;
  readonly _ZN4core5slice4sort8unstable8heapsort8heapsort17h10ab919a00dd6820E: (a: number, b: number, c: number) => void;
  readonly _ZN5alloc11collections9vec_deque21VecDeque$LT$T$C$A$GT$4grow17h24a6887072178279E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h08158a7240b514deE: (a: number, b: number) => void;
  readonly _ZN5alloc11collections9vec_deque21VecDeque$LT$T$C$A$GT$4grow17h35c7098b09020ceaE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h11c8a871b37c1c30E: (a: number, b: number) => void;
  readonly _ZN5alloc11collections9vec_deque21VecDeque$LT$T$C$A$GT$4grow17h647955db0b6454e6E: (a: number, b: number) => void;
  readonly _ZN5alloc4sync16Arc$LT$T$C$A$GT$9drop_slow17h39a7300d481853dfE: (a: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h3dfcb3c46ea85590E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h4d9ba7df218337f4E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h9a4c0929f5a74228E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17ha176e423ff719328E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hb508504d3d856a98E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hc533d1ce3b6c25a4E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17he053ac801f20a3e6E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hee32432c35de1a8dE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hf0540526398d5046E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms9gradients28calculate_gradient_magnitude17h0b257e50ed9c5d6cE: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core10algorithms9gradients24calculate_local_variance17hb7687636c067be15E: (a: number, b: number, c: number, d: number) => number;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17hd3f877be84732484E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h35274aa3324f7c49E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h9eebf32fd9f47607E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h08de6e5b4f57a8a9E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h15979fe98fc25a74E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h426653bf6670bb73E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h4500af13307cecb8E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h6f6ab19e7b518490E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h717d81abfdb76c5eE: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h7c6ff1091d5db2c8E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17h855dc6bc6e2888d2E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17he933990db0409076E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core10algorithms13adaptive_dots21analyze_image_regions17haaae3e2554e6556bE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms13adaptive_dots26calculate_adaptive_density17h8fdc34aa25404f0eE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms13adaptive_dots22apply_adaptive_density17h124f57f4fe19817bE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms13adaptive_dots21poisson_disk_sampling17h7ed4e64994f58555E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms13adaptive_dots26smooth_density_transitions17h18d0e738887e326cE: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly _ZN14vectorize_core10algorithms13adaptive_dots22generate_adaptive_dots17h35e1b724ea271373E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core10algorithms10background26detect_background_advanced17h9ccb946a884c5608E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms4dots13generate_dots17hc2193f2e24287803E: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly _ZN14vectorize_core10algorithms10background8LabColor11distance_to17ha828068013a60937E: (a: number, b: number) => number;
  readonly _ZN14vectorize_core10algorithms10background26calculate_color_similarity17h182aa822da632190E: (a: number, b: number) => number;
  readonly _ZN14vectorize_core10algorithms10background18sample_edge_pixels17h11fe0d2c1fbb517dE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10background22detect_background_mask17h01f43071640fab64E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles8DotStyle10all_styles17h2737abb3ae8baff4E: (a: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles19add_artistic_jitter17hde422055a861f821E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles31add_artistic_jitter_with_config17h291f06355be834dbE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles18add_size_variation17hf720e6cdcd3cfbe2E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles30add_size_variation_with_config17haf9f934db79aec12E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles21add_opacity_variation17hb183acddef8acd47E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles33add_opacity_variation_with_config17h0b2d54159d7660bdE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles22apply_artistic_effects17h9a45622232d6fa3eE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10dot_styles20apply_grid_alignment17ha68abd36d44b543bE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms4dots3Dot11distance_to17h47aaefe817e8d6eeE: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core10algorithms4dots3Dot13overlaps_with17hfd2718c686cb591cE: (a: number, b: number) => number;
  readonly _ZN86_$LT$vectorize_core..algorithms..dots..DotConfig$u20$as$u20$core..default..Default$GT$7default17hc779c20cd1fc5a5bE: (a: number) => void;
  readonly _ZN14vectorize_core10algorithms4dots29generate_dots_auto_background17h3fe1d2201fe9957aE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms4dots34generate_dots_with_smart_filtering17h688ad7a96bfe526dE: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN14vectorize_core10algorithms4dots24generate_dots_from_image17h44d2a02c31a343aaE: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core10algorithms9gradients35analyze_image_gradients_with_config17h1d6c6c273682ae21E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms14dots_optimized21OptimizedDotGenerator3new17h90221beca882f00dE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool7DotPool3new17haa357654aaad28fbE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms14dots_optimized21OptimizedDotGenerator23generate_dots_optimized17h688c74f2ceda59d7E: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler12start_timing17h91999ad3ece9cfd3E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core11performance14parallel_utils15ParallelContext20calculate_chunk_size17hfb1461ed387b76bcE: (a: number, b: number) => number;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler10end_timing17h0a6250e6fae9d476E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler17increment_counter17hcf44bf6014d02f84E: (a: number, b: number, c: number, d: bigint) => void;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid3new17h523ebd07a3b68e52E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid17is_position_valid17h64e5265cea9c010fE: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler19record_memory_usage17ha263b83610a7f043E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms14dots_optimized21OptimizedDotGenerator22get_performance_report17h9acf5965252e382cE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler15generate_report17h995dcd4edaad9f37E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms14dots_optimized21OptimizedDotGenerator22clear_performance_data17hf4e06de8de7985b4E: (a: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler5clear17hef61829acc9c1381E: (a: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool11PoolManager9clear_all17h091fc2fa49612372E: (a: number) => void;
  readonly _ZN14vectorize_core10algorithms14dots_optimized27analyze_gradients_optimized17hb6f4c551c953f183E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms14dots_optimized27detect_background_optimized17h44f7e9d4e36a34e4E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core11performance8simd_ops19simd_color_distance17h3c329a037342fc80E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core10algorithms14dots_optimized32generate_dots_optimized_pipeline17h51861999abc8d5ccE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms5edges12EdgeResponse3new17h9adfc42abd66bf86E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms5edges12EdgeResponse13get_magnitude17hd6f512d0c148ae8cE: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core10algorithms5edges12EdgeResponse15get_orientation17h041dff8f03f11237E: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core5utils9wasm_time7Instant3now17hec9b5acd7fae9832E: () => number;
  readonly _ZN14vectorize_core5utils9wasm_time7Instant7elapsed17h26668f974ea57260E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms5edges12compute_xdog17hf57e9bc0dc39a26fE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms5edges9apply_nms17hfb5027db44207321E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms5edges20hysteresis_threshold17h36619977735d4c4cE: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN14vectorize_core10algorithms5edges29compute_multi_direction_edges17h7b1ccbb1fff9e2b1E: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly _ZN14vectorize_core10algorithms3etf11compute_etf17h2bab9c3523b85884E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms3etf8EtfField3new17h66098e47a1930e90E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms3etf8EtfField11get_tangent17h03ecf8e2f4481a2cE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms3etf8EtfField13get_coherency17hc5dc33140556696bE: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core10algorithms3etf8EtfField11set_tangent17hde461e0ac3888e77E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core10algorithms3etf8EtfField13set_coherency17h52242a903e371779E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms3fit11CubicBezier9curvature17h42ddad54844df62dE: (a: number, b: number) => number;
  readonly _ZN14vectorize_core10algorithms3fit11CubicBezier16to_svg_path_data17h6e71a742dcbd6d11E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms3fit11fit_beziers17hfbd1bf2040a7eca5E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms9gradients16GradientAnalysis21get_gradient_strength17h8be18201d3c06cedE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms9gradients23analyze_image_gradients17h6f1915862ee45a1dE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms10hand_drawn27apply_hand_drawn_aesthetics17hd01547c894759577E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms10path_utils33calculate_douglas_peucker_epsilon17h5074fac0d1c40d4bE: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core10algorithms10path_utils24douglas_peucker_simplify17hc78d0b25f637e42dE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms10path_utils27visvalingam_whyatt_simplify17h56faa5c9a2d92f97E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms10path_utils11smooth_path17h5a8fc6265d301186E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms10path_utils21calculate_path_length17hb4025bd10f228051E: (a: number, b: number) => number;
  readonly _ZN14vectorize_core10algorithms10path_utils13resample_path17h9a8813bd1892ee76E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms10path_utils11CubicBezier14to_svg_command17h6dcd1e194a0ac8d4E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms10path_utils26schneider_fit_cubic_bezier17h2f426e5fd2f7f8ebE: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core10algorithms10path_utils27fitting_results_to_svg_path17h3a23b2117376e599E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core10algorithms8svg_dots10SvgElement8from_dot17hea6137a884c6152eE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms8svg_dots20dots_to_svg_elements17h8680bf8e641d1432E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms8svg_dots16optimize_dot_svg17hf708e5acb1a87866E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms8svg_dots23dots_to_svg_with_config17h714223afec9de1f3E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms8svg_dots17dots_to_svg_paths17h54110ddca912fee2E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms8svg_dots25generate_dot_svg_document17h02ae325a53088079E: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly _ZN14vectorize_core3svg21generate_svg_document17h5939e8af7c003cfcE: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly _ZN14vectorize_core10algorithms5trace15trace_polylines17h4f7d7672eba4c1b4E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms9trace_low16ThresholdMapping3new17h0e5106bc8460f058E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms9trace_low19vectorize_trace_low17h5a75fe03ebdece32E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms9trace_low31vectorize_trace_low_single_pass17h2aed329d6f76d96bE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms9trace_low31vectorize_trace_low_directional17h4d66616cc124b835E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms9trace_low29vectorize_trace_low_multipass17hae97b8e5232cb14bE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core10algorithms5Point11distance_to17hd7ad53eedaa54399E: (a: number, b: number) => number;
  readonly _ZN14vectorize_core10algorithms7SvgPath3new17h443500c17e6c2989E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core10algorithms7SvgPath10new_stroke17hc3f05841014b967aE: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core10algorithms7SvgPath8new_fill17hc60b589d6268e7e0E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core6config10validation25validate_image_dimensions17h140ed27de2a35346E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core6config10validation20validate_color_count17h52036d27aae07c0fE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core6config10validation19validate_iterations17he1dfe321b8814181E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core6config10validation18validate_tolerance17h167e47139ffa790cE: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder26dot_size_range_from_string17h9f08740b6a9b356dE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder21build_with_hand_drawn17h184604b6bcb78f7dE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder18available_backends17h82f80f4439f8eefeE: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder28available_hand_drawn_presets17hfefd1e337909bc73E: (a: number) => void;
  readonly _ZN14vectorize_core14config_builder13ConfigBuilder27get_backend_recommendations17h01798f3f4ae4ef4cE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core5error10validation25validate_image_dimensions17h037e49242a2b5233E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core5error10validation20validate_color_count17h6db9c50645ab41c7E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core5error10validation19validate_iterations17h4ab5fb0f6971255cE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core5error10validation18validate_tolerance17hce003e0a67ddaa15E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core5error10validation23check_memory_allocation17h729a33a09bd9ffe1E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core9execution19current_num_threads17h21c451300e169651E: () => number;
  readonly _ZN14vectorize_core9execution19should_use_parallel17h49eb7bb050b75c3dE: (a: number, b: number) => number;
  readonly _ZN14vectorize_core11performance11memory_pool7DotPool7acquire17h75b246cde29fa898E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool7DotPool7release17hade93bab19c3455cE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool7DotPool13acquire_batch17h95c1e3418a0d801aE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool7DotPool13release_batch17h84dccc20725a324bE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool7DotPool5clear17hfa0bf06bddbfcf36E: (a: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool7DotPool13shrink_to_fit17h69b75fc0f6a4bea1E: (a: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool17ThreadSafeDotPool3new17h93362dbae3368f79E: (a: number, b: number) => number;
  readonly _ZN14vectorize_core11performance11memory_pool17ThreadSafeDotPool7acquire17h29872004cebd369aE: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool17ThreadSafeDotPool7release17h671b19c77bb3d7a7E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool17ThreadSafeDotPool5stats17hf16bd8f838d96d42E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool17ThreadSafeDotPool5clear17hbbc94078d06b498fE: (a: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool11PoolManager3new17h4b8cc55f3eb0d747E: (a: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool11PoolManager22get_or_create_vec_pool17hb3393c469c3b1836E: (a: number, b: number, c: number, d: number) => number;
  readonly _ZN14vectorize_core11performance11memory_pool11PoolManager14combined_stats17h5cadb500da63e27bE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance11memory_pool11PoolManager12optimize_all17haa4c33cacbdd2ff7E: (a: number) => void;
  readonly _ZN96_$LT$vectorize_core..performance..memory_pool..PoolManager$u20$as$u20$core..default..Default$GT$7default17hbd24210f806f0ee6E: (a: number) => void;
  readonly _ZN14vectorize_core11performance14parallel_utils15ParallelContext19should_use_parallel17hd57022f406af89bcE: (a: number, b: number) => number;
  readonly _ZN14vectorize_core11performance14parallel_utils15ParallelContext21record_work_completed17h403fedb4539caebfE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance14parallel_utils15ParallelContext14set_total_work17h7fa04177608daa63E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance14parallel_utils15ParallelContext12get_progress17h3f83e0bb4856e32eE: (a: number) => number;
  readonly _ZN14vectorize_core11performance14parallel_utils14PixelProcessor3new17h9408812be837a7bfE: (a: number) => number;
  readonly _ZN14vectorize_core11performance14parallel_utils14PixelProcessor12get_progress17hef7a935ea1291a2eE: (a: number) => number;
  readonly _ZN14vectorize_core11performance14parallel_utils23AdaptiveWorkDistributor29calculate_adaptive_chunk_size17h1baf136a49a08bf3E: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core11performance14parallel_utils23AdaptiveWorkDistributor18record_performance17h048f03123534c077E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hf7fd14d73bbe5d72E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance14parallel_utils17ThreadPoolManager3new17hb4b8b5e228678a30E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance14parallel_utils17ThreadPoolManager5stats17h07e14c4dce77d3e8E: (a: number, b: number) => void;
  ...
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler3new17hf0585c290c630995E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler16get_timing_stats17h888b0979b6dcdae5E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler11get_counter17hcfffb38efbdce263E: (a: number, b: number, c: number) => bigint;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler16get_memory_usage17h7840d002427c9ef0E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler14get_operations17h525f48b9eb19c5c6E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler11set_enabled17heff331df306e1fdaE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance8profiler19PerformanceProfiler11export_json17h83483a082fdfb841E: (a: number, b: number) => void;
  ...
  readonly _ZN101_$LT$vectorize_core..performance..profiler..PerformanceProfiler$u20$as$u20$core..default..Default$GT$7default17h325a8dfa30f54070E: (a: number) => void;
  readonly _ZN14vectorize_core11performance8profiler17PerformanceReport17slowest_operation17hc4e17032863ad7d7E: (a: number) => number;
  readonly _ZN14vectorize_core11performance8profiler17PerformanceReport30operations_exceeding_threshold17hfe1e0782478faf34E: (a: number, b: number, c: bigint, d: number) => void;
  readonly _ZN14vectorize_core11performance8profiler17PerformanceReport7summary17ha349ba7345c0d60fE: (a: number, b: number) => void;
  ...
  readonly _ZN14vectorize_core11performance8profiler18ThreadSafeProfiler3new17h1d64cc9464e9a351E: (a: number) => number;
  readonly _ZN14vectorize_core11performance8profiler18ThreadSafeProfiler12start_timing17he5f0b5fb3324f99eE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core11performance8profiler18ThreadSafeProfiler10end_timing17h6b0695d7a24c8212E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core11performance8profiler18ThreadSafeProfiler17increment_counter17hf35b3b964325dfc8E: (a: number, b: number, c: number, d: bigint) => void;
  readonly _ZN14vectorize_core11performance8profiler18ThreadSafeProfiler15generate_report17h3d532f6e5ff1c5edE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance8profiler18ThreadSafeProfiler5clear17h68aaabb73070b3bfE: (a: number) => void;
  readonly _ZN14vectorize_core11performance8profiler11ScopedTimer3new17hbb962ae01d0cdf47E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN92_$LT$vectorize_core..performance..profiler..ScopedTimer$u20$as$u20$core..ops..drop..Drop$GT$4drop17h22ab7cd762beb75fE: (a: number) => void;
  readonly _ZN14vectorize_core11performance8simd_ops23simd_gradient_magnitude17ha5bb44cf509e8e74E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core11performance8simd_ops23simd_distances_to_point17hcb1a0db0cc36aee0E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core11performance8simd_ops27get_available_simd_features17hf31d6ec69f701ebaE: (a: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hf35776d4fb5e6553E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid7add_dot17hb4791a7e6499e09eE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid10remove_dot17hd38bc39250805d77E: (a: number, b: number, c: number, d: number) => number;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid19find_dots_in_radius17h64f195aed47ca12fE: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid17get_cell_contents17ha92d1b72de4f65daE: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid5stats17ha9cf181591df66bdE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid13shrink_to_fit17hb23204c258802a04E: (a: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index11SpatialGrid25optimize_for_distribution17h89ba846cea3f6136E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index8QuadTree6insert17hbab3b6ff2ff7c0d8E: (a: number, b: number, c: number, d: number) => number;
  readonly _ZN14vectorize_core11performance13spatial_index8QuadTree12query_radius17h184061b19dfb6201E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index8QuadTree5clear17h4273771b2604c515E: (a: number) => void;
  readonly _ZN14vectorize_core11performance13spatial_index8QuadTree5count17h12bb9d4e01c7d71aE: (a: number) => number;
  readonly _ZN14vectorize_core11performance16PerformanceStats18avg_operation_time17hf75d4f9785f744e0E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance16PerformanceStats5merge17hc9a2fb59fe1ce5c1E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core11performance16PerformanceUtils18optimal_chunk_size17h7e8c0d57a73dee91E: (a: number, b: number) => number;
  readonly _ZN14vectorize_core11performance16PerformanceUtils36calculate_optimal_parallel_threshold17hd531483282824723E: () => number;
  readonly _ZN14vectorize_core13preprocessing3old12resize_image17h651e242cd96c8966E: (a: number, b: number, c: number) => void;
  ...
  readonly _ZN14vectorize_core13preprocessing3old17rgba_to_grayscale17h2e8bb1e7a484dbfbE: (a: number, b: number) => void;
  readonly _ZN14vectorize_core13preprocessing3old22standardize_image_size17habe91d880f19ce48E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core13preprocessing3old12fast_denoise17hb666d029bf6c718eE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core13preprocessing3old13gaussian_blur17h0a301b9aa9b93f7fE: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly _ZN14vectorize_core13preprocessing3old19preprocess_for_logo17h7276303abfe843cbE: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core13preprocessing3old22preprocess_for_regions17h945511f46a8d5c04E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core13preprocessing3old15apply_threshold17h7349db118ff4aa13E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core13preprocessing3old24calculate_otsu_threshold17h46be0f6f4d74c0ceE: (a: number, b: number) => number;
  readonly _ZN14vectorize_core13preprocessing3old10rgb_to_lab17h6ca9e8deb648060aE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core13preprocessing3old10lab_to_rgb17h850d00f42b4fc6c4E: (a: number, b: number, c: number) => number;
  readonly _ZN14vectorize_core13preprocessing3old16bilateral_filter17h47cbb7b7387916dfE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core13preprocessing27apply_resolution_processing17hf16e07ac32786a79E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core13preprocessing21scale_svg_coordinates17h00b2f9efdc03baeeE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core3svg13optimize_data17hf009a4268c088700E: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly _ZN14vectorize_core3svg10minify_svg17hdff80b153151abb4E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core3svg18validate_svg_paths17ha4870ea75170869fE: (a: number, b: number, c: number) => void;
  readonly _ZN4core3str7pattern11StrSearcher3new17h5d8bed8e1fa66af4E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core3svg16create_rectangle17ha45ef590e97dee5aE: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly _ZN14vectorize_core3svg13create_circle17h1042aa69f4920c12E: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly _ZN14vectorize_core9telemetry15write_json_dump17h23f9fc21591fec78E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core9telemetry15append_runs_csv17hadd7f03a9720880cE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN6chrono6offset3utc3Utc3now17hf434da1a088b59d3E: (a: number) => void;
  readonly _ZN14vectorize_core9telemetry9make_dump17h4a228665de110339E: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => void;
  readonly _ZN14vectorize_core5utils9wasm_time7Instant14duration_since17h07302753cd8c6ba5E: (a: number, b: number, c: number) => void;
  readonly _ZN14vectorize_core5utils9wasm_time5Timer3new17hce9b0bbea1d9e202E: () => number;
  readonly _ZN14vectorize_core5utils9wasm_time5Timer7elapsed17h1cf1775b005add60E: (a: number, b: number) => void;
  readonly _ZN14vectorize_core5utils9wasm_time5Timer10elapsed_ms17hcceb6c9cc9491e4aE: (a: number) => number;
  readonly _ZN14vectorize_core5utils9wasm_time5Timer5reset17h15975883749e368dE: (a: number) => void;
  readonly _ZN198_$LT$vectorize_core..algorithms..edges.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..edges..FdogConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17ha331729b59c9a51aE: (a: number, b: number) => number;
  readonly _ZN198_$LT$vectorize_core..algorithms..edges.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..edges..XdogConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h30fc7927e55f644fE: (a: number, b: number) => number;
  readonly _ZN197_$LT$vectorize_core..algorithms..edges.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..edges..NmsConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h30f181430a676fd9E: (a: number, b: number) => number;
  readonly _ZN193_$LT$vectorize_core..algorithms..etf.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..etf..EtfConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h12e3b390900d7e37E: (a: number, b: number) => number;
  readonly _ZN193_$LT$vectorize_core..algorithms..fit.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..fit..FitConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h0f96a7bd5190077fE: (a: number, b: number) => number;
  readonly _ZN195_$LT$vectorize_core..algorithms..fit.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..fit..CubicBezier$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h4a21e27c2a0a29bfE: (a: number, b: number) => number;
  readonly _ZN199_$LT$vectorize_core..algorithms..trace.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..trace..TraceConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h5b42407c3c8da084E: (a: number, b: number) => number;
  readonly _ZN208_$LT$vectorize_core..algorithms..trace_low.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..trace_low..TraceBackend$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h953bee9731aa8c49E: (a: number, b: number) => number;
  readonly _ZN215_$LT$vectorize_core..algorithms..trace_low.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..trace_low..ProcessingDirection$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h27a9db801d73ba02E: (a: number, b: number) => number;
  readonly _ZN210_$LT$vectorize_core..algorithms..trace_low.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..trace_low..TraceLowConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h2d7e90b79fd28b25E: (a: number, b: number) => number;
  readonly _ZN179_$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..Point$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h518866dd2beed485E: (a: number, b: number) => number;
  readonly _ZN193_$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgElementType$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h99b060d075e2a9dbE: (a: number, b: number) => number;
  readonly _ZN188_$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgElementType$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h06fdb971cd2dd812E: (a: number, b: number) => number;
  readonly _ZN249_$LT$$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgElementType$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$..visit_enum..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17hbe76d3132e959df9E: (a: number, b: number) => number;
  readonly _ZN249_$LT$$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgElementType$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$..visit_enum..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17hd0635e42569ab3edE: (a: number, b: number) => number;
  readonly _ZN249_$LT$$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgElementType$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$..visit_enum..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h10aa5a99974abca7E: (a: number, b: number) => number;
  readonly _ZN181_$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgPath$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h6069ddd3fc352a09E: (a: number, b: number) => number;
  readonly _ZN182_$LT$vectorize_core..config.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..config..Milestone2Config$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17hb861e2a4796bc766E: (a: number, b: number) => number;
  readonly _ZN184_$LT$vectorize_core..config.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..config..TraceDefaultConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17he4c5511168640f4aE: (a: number, b: number) => number;
  readonly _ZN182_$LT$vectorize_core..config.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..config..FitDefaultConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h1e76c8a770f8ee0cE: (a: number, b: number) => number;
  readonly _ZN180_$LT$vectorize_core..config.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..config..SvgConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h0f13e4f5d2fcb01eE: (a: number, b: number) => number;
  readonly _ZN175_$LT$vectorize_core..config.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..config..SvgConfig$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$9expecting17hf2b7cfb38cc2ca38E: (a: number, b: number) => number;
  readonly _ZN61_$LT$serde_json..error..Error$u20$as$u20$core..fmt..Debug$GT$3fmt17hf88706c273dbfe20E: (a: number, b: number) => number;
  readonly _ZN14vectorize_core13preprocessing3old12lab_distance17hd47b64dc2bbf8968E: (a: number, b: number) => number;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h229841237b8c11fdE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h3c205d6ff8d33b7bE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h63378c41792b1832E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h69c4460713acfb64E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h77ada39005297c9aE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hb84bd723ec78264eE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hb9c8a43acbc506c9E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hbfd9a40ae3140dafE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hbfe4ac532ef1ed8cE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hc6d5fa632495e7eeE: (a: number, b: number) => void;
  readonly _ZN82_$LT$vectorize_core..utils..wasm_time..Timer$u20$as$u20$core..default..Default$GT$7default17h2dcbf316a498021bE: () => number;
  readonly _ZN203_$LT$vectorize_core..algorithms..edges.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..edges..XdogConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17hc97aa277a12c62fdE: (a: number, b: number) => number;
  readonly _ZN203_$LT$vectorize_core..algorithms..edges.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..edges..FdogConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17he165fcd1406bf73eE: (a: number, b: number) => number;
  readonly _ZN202_$LT$vectorize_core..algorithms..edges.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..edges..NmsConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h7977decb417d91aeE: (a: number, b: number) => number;
  readonly _ZN198_$LT$vectorize_core..algorithms..fit.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..fit..FitConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17hd256ef75b300c725E: (a: number, b: number) => number;
  readonly _ZN200_$LT$vectorize_core..algorithms..fit.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..fit..CubicBezier$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17ha0355321a8d0246eE: (a: number, b: number) => number;
  readonly _ZN204_$LT$vectorize_core..algorithms..trace.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..trace..TraceConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17hd37990c16aa822f0E: (a: number, b: number) => number;
  readonly _ZN220_$LT$vectorize_core..algorithms..trace_low.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..trace_low..ProcessingDirection$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17hfe15a1991255624cE: (a: number, b: number) => number;
  readonly _ZN215_$LT$vectorize_core..algorithms..trace_low.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..trace_low..TraceLowConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17he305f097ac146b70E: (a: number, b: number) => number;
  readonly _ZN198_$LT$vectorize_core..algorithms..etf.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..etf..EtfConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h00b117b3fc5055d9E: (a: number, b: number) => number;
  readonly _ZN213_$LT$vectorize_core..algorithms..trace_low.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..trace_low..TraceBackend$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h6ccc18d19b81fe30E: (a: number, b: number) => number;
  readonly _ZN254_$LT$$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgElementType$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$..visit_enum..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h420192f51446c173E: (a: number, b: number) => number;
  readonly _ZN254_$LT$$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgElementType$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$..visit_enum..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h0efaecad7cdd1849E: (a: number, b: number) => number;
  readonly _ZN254_$LT$$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgElementType$GT$..deserialize..__Visitor$u20$as$u20$serde..de..Visitor$GT$..visit_enum..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h48e46c353c9c58d2E: (a: number, b: number) => number;
  readonly _ZN186_$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..SvgPath$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17ha08c895ad6e6d6a1E: (a: number, b: number) => number;
  readonly _ZN187_$LT$vectorize_core..config.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..config..Milestone2Config$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h930be4a72553da84E: (a: number, b: number) => number;
  readonly _ZN189_$LT$vectorize_core..config.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..config..TraceDefaultConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h2f4f8995bc988212E: (a: number, b: number) => number;
  readonly _ZN187_$LT$vectorize_core..config.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..config..FitDefaultConfig$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17ha46b5c53b37e5021E: (a: number, b: number) => number;
  readonly _ZN184_$LT$vectorize_core..algorithms.._..$LT$impl$u20$serde..de..Deserialize$u20$for$u20$vectorize_core..algorithms..Point$GT$..deserialize..__FieldVisitor$u20$as$u20$serde..de..Visitor$GT$9expecting17h21e3a3cdb25c9416E: (a: number, b: number) => number;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h5100859961033738E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hc57bd30e65d98aeeE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hd64459265eaf79afE: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hd85fc96b363531f8E: (a: number, b: number) => void;
  readonly _ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17hdfe692b47ae342ccE: (a: number, b: number) => void;
  readonly _ZN9hashbrown3raw21RawTable$LT$T$C$A$GT$14reserve_rehash17ha732ca4d79617d34E: (a: number, b: number, c: number, d: number, e: number) => void;
  ...
  readonly closure1298_externref_shim: (a: number, b: number, c: any, d: number, e: any) => number;
  readonly closure1299_externref_shim_multivalue_shim: (a: number, b: number, c: any, d: number, e: any) => [number, number];
  readonly closure1300_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
  readonly closure1301_externref_shim: (a: number, b: number, c: any, d: number, e: any) => any;
  readonly closure1302_externref_shim: (a: number, b: number, c: any, d: any, e: number, f: any) => any;
  readonly closure1303_externref_shim: (a: number, b: number, c: any) => number;
  readonly closure1304_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly closure1300_externref_shim19: (a: number, b: number, c: any, d: any, e: any) => void;
  readonly closure1305_externref_shim: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1306_externref_shim: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1300_externref_shim22: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1305_externref_shim23: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1306_externref_shim24: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1300_externref_shim25: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1307_externref_shim: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1308_externref_shim: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1309_externref_shim: (a: number, b: number, c: bigint, d: number, e: any) => void;
  readonly closure1309_externref_shim29: (a: number, b: number, c: bigint, d: number, e: any) => void;
