...
export const showcaseAlgorithms: ShowcaseAlgorithm[] = [
	{
		...
		description:
			'Transform portraits into elegant line drawings with natural, hand-drawn aesthetics that capture facial features and expressions beautifully.',
		icon: PenTool,
		bestFor: 'Portrait Photography',
		features: ['Facial detail preservation', 'Natural line flow', 'Expressive strokes'],
	...
	},
	{
		...
		description:
			'Transform game characters and assets into modern, geometric art with bold color regions perfect for logos and branding.',
		icon: Grid3x3,
		bestFor: 'Gaming & Icons',
		features: ['Bold color blocks', 'Clean geometry', 'Brand-friendly'],
	...
	},
	{
		...
		description:
			'Turn artistic images into stunning stippled masterpieces with organic dot patterns that emphasize texture and energy.',
		icon: Zap,
		bestFor: 'Abstract Art',
		features: ['Organic patterns', 'Energy flow', 'Textural depth'],
	...
	},
	{
		...
		description:
			'Transform historical photographs into artistic interpretations that preserve the gravity and significance of important moments.',
		icon: BarChart3,
	...
	},
	{
		...
		technicalName: 'Superpixel Portrait Mode',
		description:
	...
	},
	{
		...
		features: ['Scientific accuracy', 'Natural forms', 'Educational value'],
