...
<div class={cn("relative flex w-full touch-none select-none items-center", className)}>
	<input
		...
		oninput={handleInput}
		class={cn(
			"w-full appearance-none bg-transparent cursor-pointer disabled:cursor-not-allowed disabled:opacity-50",
			"[&::-webkit-slider-track]:h-2 [&::-webkit-slider-track]:w-full [&::-webkit-slider-track]:rounded-full [&::-webkit-slider-track]:bg-secondary",
			...
			"[&::-webkit-slider-thumb]:focus-visible:outline-none [&::-webkit-slider-thumb]:focus-visible:ring-2 [&::-webkit-slider-thumb]:focus-visible:ring-ring",
			"[&::-webkit-slider-thumb]:focus-visible:ring-offset-2",
			"[&::-moz-range-track]:h-2 [&::-moz-range-track]:w-full [&::-moz-range-track]:rounded-full [&::-moz-range-track]:bg-secondary",
			...
			"[&::-moz-range-thumb]:focus-visible:outline-none [&::-moz-range-thumb]:focus-visible:ring-2 [&::-moz-range-thumb]:focus-visible:ring-ring",
