		...
		>
			...
			<div class="mb-4 flex items-center justify-between">
				<div class="flex items-center gap-2">
					<Download class="text-ferrari-600 h-5 w-5" />
			...
			<div class="space-y-3">
				...
				<button
					...
					disabled={isProcessing || isGeneratingWebP}
					class="hover:border-ferrari-300 focus:border-ferrari-500 focus:ring-ferrari-500/20 dark:hover:border-ferrari-600 flex w-full items-center gap-6 rounded-lg border-2 border-gray-200 p-6 text-left transition-all hover:bg-gray-50 focus:ring-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:hover:bg-gray-800"
				>
					<div
						class="bg-ferrari-100 dark:bg-ferrari-900 flex h-20 w-20 items-center justify-center rounded-lg"
					>
						<FileText class="text-ferrari-600 h-10 w-10" />
					</div>
					<div class="flex-1">
				...
				>
					<div
						class="bg-ferrari-100 dark:bg-ferrari-900 flex h-20 w-20 items-center justify-center rounded-lg"
					>
						<Image class="text-ferrari-600 h-10 w-10" />
					</div>
					<div class="flex-1">
						<div class="flex items-center justify-between">
					...
					{#if isGeneratingWebP}
						<div class="ml-2">
							<div
								class="border-t-ferrari-600 h-4 w-4 animate-spin rounded-full border-2 border-gray-300"
							></div>
						</div>
					{/if}
				</button>
			...
			<div class="mt-4 border-t border-gray-200 pt-4 dark:border-gray-700">
				<p class="text-center text-xs text-gray-500 dark:text-gray-400">
					Press <kbd class="rounded bg-gray-200 px-1 py-0.5 text-xs dark:bg-gray-700">1</kbd> for
					SVG,
