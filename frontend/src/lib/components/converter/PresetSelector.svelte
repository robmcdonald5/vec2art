	...
	{#if selectedPreset && selectedPreset !== 'custom'}
		...
		>
			<div class="flex items-start gap-2">
				...
				>
					<SelectedIcon class="h-3.5 w-3.5 text-green-600 dark:text-green-400" aria-hidden="true" />
				</div>
				<div class="flex-1">
	...
	{:else if selectedPreset === 'custom'}
		...
		>
			<div class="flex items-start gap-2">
				...
				<div class="flex-1">
					<p class="text-sm font-medium text-amber-700 dark:text-amber-300">Custom Configuration</p>
