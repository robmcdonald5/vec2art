...
export interface InitOutput {
  ...
  readonly _ZN14vectorize_core24vectorize_trace_low_rgba17h7218eb1a26919f65E: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly _ZN14vectorize_core10algorithms9trace_low19vectorize_trace_low17h14e0d2a139e71764E: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms9trace_low31vectorize_trace_low_single_pass17h7f5e961fe5e082daE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms9trace_low29vectorize_trace_low_multipass17h4192705ad3490e6bE: (a: number, b: number, c: number, d: number) => void;
  readonly _ZN14vectorize_core10algorithms9trace_low31vectorize_trace_low_directional17h6d2283487a5c8227E: (a: number, b: number, c: number, d: number) => void;
  ...
  readonly closure1193_externref_shim: (a: number, b: number, c: any, d: number, e: any) => number;
  readonly closure1194_externref_shim_multivalue_shim: (a: number, b: number, c: any, d: number, e: any) => [number, number];
  readonly closure1195_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
  readonly closure1196_externref_shim: (a: number, b: number, c: any, d: number, e: any) => any;
  readonly closure1197_externref_shim: (a: number, b: number, c: any, d: any, e: number, f: any) => any;
  readonly closure1198_externref_shim: (a: number, b: number, c: any) => number;
  readonly closure1199_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly closure1195_externref_shim19: (a: number, b: number, c: any, d: any, e: any) => void;
  readonly closure1200_externref_shim: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1201_externref_shim: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1195_externref_shim22: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1200_externref_shim23: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1201_externref_shim24: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1195_externref_shim25: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1202_externref_shim: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1203_externref_shim: (a: number, b: number, c: number, d: number, e: any) => void;
  readonly closure1204_externref_shim: (a: number, b: number, c: bigint, d: number, e: any) => void;
  readonly closure1204_externref_shim29: (a: number, b: number, c: bigint, d: number, e: any) => void;
