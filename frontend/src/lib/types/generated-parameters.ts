...
export interface EdgeBackendConfig extends Pick<VectorizerConfig,
  'noise_filtering' |
  'enable_reverse_pass' |
...
export interface CenterlineBackendConfig extends Pick<VectorizerConfig,
  'noise_filtering' |
...
export interface SuperpixelBackendConfig extends Pick<VectorizerConfig,
...
export interface DotsBackendConfig extends Pick<VectorizerConfig,
 ...
 */
export function validateParameter(paramName: string, value: any): { valid: boolean; error?: string } {
