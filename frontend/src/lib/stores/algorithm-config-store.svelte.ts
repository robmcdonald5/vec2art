...
class AlgorithmConfigStore {
    ...
    constructor() {
        console.log('[AlgorithmConfigStore] Constructor - browser:', browser, 'localStorage available:', typeof localStorage !== 'undefined');
    ...
    private loadSavedConfigs() {
        console.log('[AlgorithmConfigStore] loadSavedConfigs - browser:', browser, 'localStorage:', typeof localStorage);
