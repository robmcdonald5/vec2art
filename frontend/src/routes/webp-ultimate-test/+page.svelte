...
<script lang="ts">
  ...
  import { UltimateWebPConverter, type UltimateConversionOptions, type UltimateConversionResult } from '$lib/services/ultimate-webp-converter';
...
<svelte:head>
  ...
  <meta name="description" content="Test all WebP conversion optimizations including WASM encoding" />
</svelte:head>
          ...
          <div class="rounded-xl bg-white p-6 shadow-sm dark:bg-gray-900">
            ...
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between">
                ...
                <span class="font-mono text-blue-600">{systemInfo.capabilities.estimatedPerformance.toUpperCase()}</span>
              </div>
            </div>
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-3">
              <label class="flex items-center gap-2">
                <input type="checkbox" bind:checked={enableWebGPU} class="rounded border-gray-300" />
                <span class="text-sm text-gray-700 dark:text-gray-300">Enable WebGPU</span>
              </label>
              
              <label class="flex items-center gap-2">
                <input type="checkbox" bind:checked={enableProgressive} class="rounded border-gray-300" />
                <span class="text-sm text-gray-700 dark:text-gray-300">Enable Progressive Streaming</span>
              </label>
            ...
            <button
              ...
              class="w-full px-4 py-3 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
            >
              {#if converting}
            ...
            <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <div class="flex flex-wrap gap-1">
                {#each result.optimizations as opt}
                  <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full dark:bg-blue-900 dark:text-blue-300">
                    {opt}
                  </span>
                {/each}
              </div>
