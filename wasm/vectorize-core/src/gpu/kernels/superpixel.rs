...
impl GpuSlicSegmentation {
    ...
    pub async fn segment(
        ...
        log::info!(
            "🎨 SLIC GPU: {}x{} image, {}x{} grid ({} clusters)",
            width,
            height,
            num_segments_x,
            num_segments_y,
        ...
        let cluster_accumulators_buffer =
        ...
        rx.await
            ...
            .map_err(|e| {
                GpuSlicError::ExecutionFailed(format!("Buffer mapping failed: {:?}", e))
            })?;
        ...
        log::info!(
            "✅ SLIC GPU segmentation completed: {} assignments",
            assignments.len()
        );
        Ok(assignments)
    }
