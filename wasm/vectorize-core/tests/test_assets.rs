...
impl TestAssets {
    ...
    pub fn generate_all_test_images() -> TestImageSet {
        TestImageSet {
            ...
            checkerboard_medium: Self::create_checkerboard_pattern(
                MEDIUM_SIZE.0,
                MEDIUM_SIZE.1,
                16,
            ),
            ...
            // Edge cases
            solid_white: Self::create_solid_color(
                SMALL_SIZE.0,
                SMALL_SIZE.1,
            ...
            // Performance testing
            performance_complex: Self::create_complex_performance_image(
                PERFORMANCE_SIZE.0,
                PERFORMANCE_SIZE.1,
            ),
        }
...
mod tests {
    ...
    fn test_config_generation() {
        ...
        assert!(
            !adaptive_configs.is_empty(),
            "Should generate adaptive configs"
        );
    ...
    fn test_image_categorization() {
        ...
        assert!(
            !performance_images.is_empty(),
            "Should have performance test images"
        );

        let quality_images = assets.get_quality_images();
        assert!(
            !quality_images.is_empty(),
            "Should have quality test images"
        );
